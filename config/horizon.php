...
return [
    ...
    */
    ...
    'defaults' => [
        // Default queue supervisor for general jobs
        'supervisor-default' => [
            'connection' => 'redis',
            'queue' => ['default'],
            'balance' => 'auto',
        ...
        // Reviews queue supervisor for review sync jobs
        // Longer timeout for Outscraper API calls
        'supervisor-reviews' => [
            'connection' => 'redis',
            'queue' => ['reviews'],
            'balance' => 'auto',
            ...
            'maxTime' => 0,
            'maxJobs' => 0,
            'memory' => 256, // Higher memory for processing large review sets
            'tries' => 2,
    ...
    'environments' => [
        'production' => [
            ...
            'supervisor-reviews' => [
                'maxProcesses' => 3, // Limit concurrent review syncs
                'balanceMaxShift' => 1,
                'balanceCooldown' => 3,
            ],
