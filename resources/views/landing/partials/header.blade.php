...
<header
    ...
    :class="scrolled ? 'bg-white/95 backdrop-blur-md shadow-lg shadow-gray-100/50' : 'bg-white/50 backdrop-blur-sm'"
    ...
    <nav class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 sm:h-20">
            ...
            <div class="hidden lg:flex items-center gap-1 xl:gap-2">
                <a
                    href="#features"
                    class="relative px-4 py-2 text-gray-600 hover:text-gray-900 font-medium transition-colors text-sm group"
                ...
                >
                    ...
                    <span class="absolute inset-0 bg-gray-100 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity"></span>
                </a>
                <a
                    href="#how-it-works"
                    class="relative px-4 py-2 text-gray-600 hover:text-gray-900 font-medium transition-colors text-sm group"
            ...
            <div class="flex items-center gap-3 sm:gap-4">
                ...
                <a
                    ...
                    target="_blank"
                    class="hidden sm:inline-flex items-center gap-2 text-gray-600 hover:text-blue-600 font-medium transition-colors text-sm"
                >
                ...
                <button
                    ...
                    class="lg:hidden p-2.5 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-xl transition-colors"
        ...
        <div class="p-6">
            ...
            <nav class="space-y-2">
                ...
                >
                    ...
                    <div>
                        <p class="font-semibold text-gray-900">{{ __('app.navFeatures') }}</p>
                        <p class="text-sm text-gray-500">اكتشف ميزات المنصة</p>
                    </div>
                </a>
                ...
                >
                    ...
                    <div>
                        <p class="font-semibold text-gray-900">{{ __('app.navHowItWorks') }}</p>
                        <p class="text-sm text-gray-500">كيف تعمل المنصة</p>
                    </div>
                </a>
                ...
                >
                    ...
                    <div>
                        <p class="font-semibold text-gray-900">{{ __('app.navPricing') }}</p>
                        <p class="text-sm text-gray-500">الأسعار والباقات</p>
                    </div>
                </a>
                ...
                >
                    ...
                    <div>
                        <p class="font-semibold text-gray-900">{{ __('app.navFAQ') }}</p>
                        <p class="text-sm text-gray-500">الأسئلة الشائعة</p>
                    </div>
                </a>
            </nav>
            ...
            >
                ...
                <div>
                    <p class="font-semibold text-gray-900">{{ __('app.navSubscribe') }}</p>
                    <p class="text-sm text-gray-500">سجل للحصول على التحديثات</p>
                </div>
            </a>
            ...
            <div class="mt-6">
                <a
                    href="{{ route('get-started') }}"
                    @click="mobileMenuOpen = false"
                    class="flex items-center justify-center gap-2 w-full bg-gradient-to-l from-[#df625b] to-[#e87b75] text-white py-4 rounded-xl font-bold text-lg shadow-lg shadow-red-500/25"
                >
            ...
            <div class="mt-8 pt-6 border-t border-gray-100">
                <p class="text-sm text-gray-500 text-center">
                    تحتاج مساعدة؟
                    <a href="mailto:support@tabsense.ai" class="text-blue-600 hover:underline">تواصل معنا</a>
                </p>
            </div>
        </div>
    </div>
