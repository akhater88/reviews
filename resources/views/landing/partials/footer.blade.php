...
<footer class="bg-gray-900 text-white py-12 sm:py-16">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-4 gap-8 sm:gap-12">
            ...
            {{-- Quick Links --}}
            <div>
                <h4 class="font-bold text-lg mb-4">{{ __('app.footerLinksTitle') }}</h4>
                <ul class="space-y-2">
                    <li>
                        <a href="#features" class="text-gray-400 hover:text-white transition-colors text-sm">
                            {{ __('app.footerFeaturesLink') }}
                        </a>
                    </li>
                    <li>
                        <a href="#pricing" class="text-gray-400 hover:text-white transition-colors text-sm">
                            {{ __('app.footerPricingLink') }}
                        </a>
                    </li>
                    <li>
                        <a href="#faq" class="text-gray-400 hover:text-white transition-colors text-sm">
                            {{ __('app.footerFAQLink') }}
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors text-sm">
                            {{ __('app.footerPrivacyPolicy') }}
                        </a>
                    </li>
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition-colors text-sm">
                            {{ __('app.footerTermsOfService') }}
                        </a>
                    </li>
                </ul>
            </div>
            ...
            {{-- Connect --}}
            <div>
                <h4 class="font-bold text-lg mb-4">{{ __('app.footerConnectTitle') }}</h4>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p class="text-gray-500 text-sm">{{ __('app.footerCopyright') }}</p>
            <p class="text-gray-500 text-sm">{{ __('app.footerMadeWith') }}</p>
        </div>
    </div>
</footer>
