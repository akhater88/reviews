...
<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
    ...
    <div class="relative h-32 sm:h-48" style="background: linear-gradient(to bottom right, rgb(59 130 246), rgb(79 70 229));">
        ...
        <div class="absolute bottom-4 right-4 left-4 sm:bottom-6 sm:right-6 sm:left-6">
            <div class="flex items-end gap-4 sm:gap-6">
                ...
                <div class="flex-1 text-white min-w-0">
                    ...
                    <div class="flex items-center" style="color: rgba(255,255,255,0.9);">
    ...
    <div class="px-4 py-3 sm:px-6 sm:py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-100 dark:border-gray-700">
        <div class="flex flex-row items-center justify-between text-sm">
            ...
            <div class="flex items-center gap-3">
                <span class="text-xs sm:text-sm px-3 py-1 rounded-full" style="background: rgb(239 246 255); color: rgb(29 78 216); border: 1px solid rgb(191 219 254);">
                    تقرير آخر 3 شهور
                </span>
